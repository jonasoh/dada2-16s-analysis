...
if (has_sample_data) {
  ...
  if (!is.null(params$sample_filter_column) && params$sample_filter_column %in% colnames(sample_data)) {
    ...
    # remove the filter column from sample_data
    sample_data <- sample_data[, !colnames(sample_data) %in% params$sample_filter_column, drop=FALSE]
    cat("   Removed filter column from sample data.\n")
  }
